...
begin
  ...
  begin
    Clear;
    Add('update frf_orden_carga_l ');
    Add('set (kilos_packing_ocl, cajas_packing_ocl, palets_packing_ocl, kilos_reales_ocl) = (:kilos, :cajas, :palets, :kilos_reales)  ');
    Add('where orden_ocl = :orden ');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        QUpdateLinCarga2.ParamByName('kilos_reales').AsFloat:= arReales[ iCount ];
      ...
      //Cambio la forma de hacer el update, por problemas al actualizar datos en sinonimo de frf_orden_l 15/09/2020
{
  ...
  begin
    ...
    begin
      ...
      QUpdateLinCarga2.ParamByName('kilos_reales').AsFloat:= QLineasCarga.FieldByName('kilos_ocl').AsFloat;
      QUpdateLinCarga2.ExecSQL;
